...
def get_config():
    global args
    if args is None:
        args = {"flame_model_path": "./dataset/model/generic_model.pkl",
                "static_landmark_embedding_path": "./dataset/model/flame_static_embedding.pkl",
                "dynamic_landmark_embedding_path": "./dataset/model/flame_dynamic_embedding.npy",
                "shape_params": 100,
